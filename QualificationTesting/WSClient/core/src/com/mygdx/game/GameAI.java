...
public class GameAI {
    ...
    public static LinkedList<OneCard> caculateHowToPlay(LinkedList<OneCard> hand, LinkedList<OneCard> withCard){
    ...
    public static LinkedList<OneCard> createFlush(LinkedList<OneCard> hand, LinkedList<OneCard> withCard){
    ...
    public static LinkedList<OneCard> createBig2Stream(LinkedList<OneCard> hand, LinkedList<OneCard> withCard){
        LinkedList<OneCard> toReturn = new LinkedList<OneCard>();
    ...
    public static LinkedList<OneCard> createFullHouse(LinkedList<OneCard> hand, LinkedList<OneCard> withCard){
    ...
    //單張出牌
    public static LinkedList<OneCard> createOneCard(LinkedList<OneCard> hand, LinkedList<OneCard> withCard){
        LinkedList<OneCard> toReturn = new LinkedList<OneCard>();
    ...
    public static LinkedList<OneCard> createPairs(LinkedList<OneCard> hand, LinkedList<OneCard> withCard){
        LinkedList<OneCard> toReturn = new LinkedList<OneCard>();
    ...
    protected static LinkedList<OneCard> createStreamWith(LinkedList<OneCard> hand, LinkedList<OneCard> withCard) {
    ...
    public static LinkedList<OneCard> createMiniStream(LinkedList<OneCard> hand, LinkedList<OneCard> withCard){
        LinkedList<OneCard> toReturn = new LinkedList<OneCard>();
        OneCard toBeat = null;
    ...
    public static LinkedList<OneCard> createFourKing(LinkedList<OneCard> hand, LinkedList<OneCard> withCard){
    ...
    public static OneCard getFourKindHead(LinkedList<OneCard> withCard){
        if(withCard.size() == 5){
    ...
    public static OneCard getPairsHead(LinkedList<OneCard> withCard){
    ...
    public static OneCard getStreamHead(LinkedList<OneCard> withCard){
    ...
    public static OneCard getRoyalStreamHead(LinkedList<OneCard> withCard){
        if(withCard.size() == 5){
    ...
    public static OneCard getBig2StreamHead(LinkedList<OneCard> withCard){
        if(withCard.size() == 5){
            int check1 = withCard.get(4).getValue();
            int check2 = withCard.get(0).getValue() + withCard.get(1).getValue() + withCard.get(2).getValue()+withCard.get(3).getValue();
    ...
    public static OneCard getMiniStream(LinkedList<OneCard> withCard){
        if(withCard.size() == 5){
            int check1 = withCard.get(4).getValue();
    ...
    public static OneCard getFullHouseHead(List<OneCard> withCard){
        if(withCard != null && withCard.size() == 5){
    ...
    public static boolean isPairs(LinkedList<OneCard> withCard){
        if(withCard.size() == 2){
    ...
    public static boolean isClubsThree(OneCard card){
    ...
    public static LinkedList<OneCard>[] getListSplitCardByColor(LinkedList<OneCard> tmpHand){
